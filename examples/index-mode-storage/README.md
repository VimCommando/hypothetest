...
# Then run
hypothetest operator run --blueprint blueprints/index-mode-storage/
```

See `generated/runbook.md` for the full step-by-step operator procedure.
...
generated/
  ...
  runbook.md           — operator step-by-step runbook
```
