...
- `static`: the Architect generates or accepts a persisted dataset fixture and includes it in the bundle. Example: `data/docs.ndjson.gz` containing 100 MB of predefined documents.
...
- Static datasets must point to a bundle-local file and should include a checksum.
